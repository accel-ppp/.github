...
You wan't to help us improve ? This is awesome!
...
In a big system, that is comprised of multiple components, it’s
...
* Help future maintainers (it could be you!) to find out why certain
...
This is nothing specific - it is more a general topic for distributed
...
## Bug Report/Issue
Issues or bugs are found in any software project.
...
an account in the [development portal](https://vyos.dev).

* Provide as much information as you can
* Which version are you using? Use operational level command:
  ``show version``
...
You have an idea of how to make better or you are in need of a specific
feature which all users would benefit from? To send a feature request
...
For contributing code please take a short moment and review the guideline
